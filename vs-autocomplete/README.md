...
```bash
 npm install vs-autocomplete@1.6.16
```

##### yarn

```bash
 yarn add vs-autocomplete@1.6.16
```

##### UMD

```html
<script src="https://cdn.jsdelivr.net/npm/vs-autocomplete@1.6.16/dist/vs-autocomplete.umd.min.js"></script>
OR
<script src="https://unpkg.com/vs-autocomplete@1.6.16/dist/vs-autocomplete.umd.js"></script>
```

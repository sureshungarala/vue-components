...
```bash
 npm install vs-autocomplete@1.6.14
```

##### yarn

```bash
 yarn add vs-autocomplete@1.6.14
```

##### UMD

```html
<script src="https://cdn.jsdelivr.net/npm/vs-autocomplete@1.6.14/dist/vs-autocomplete.umd.min.js"></script>
OR
<script src="https://unpkg.com/vs-autocomplete@1.6.14/dist/vs-autocomplete.umd.js"></script>
```

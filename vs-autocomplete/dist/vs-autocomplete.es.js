(function(){"use strict";try{if(typeof document<"u"){var a=document.createElement("style");a.id="vs-autocomplete",a.appendChild(document.createTextNode(".v-tree-dropdown[data-v-ac458dbc]{--primary-color: #1f73b7;--background-color: #1f73b714;--hint-color: #828485;--border: 1px solid #d8dcde;--v-dropdown-width: 300px;--max-width: 10000000px;--box-shadow: rgb(31 115 183 / 35%) 0px 0px 0px 3px;--bezier-curve: .1s cubic-bezier(0, 0, .95, 1.03);--animation-delay: .2s;position:relative;width:var(--v-dropdown-width);max-width:var(--max-width);outline:none}.v-dd[data-v-ac458dbc]{display:flex;flex-direction:column}#v-dd-label[data-v-ac458dbc],.v-dd-option>.label[data-v-ac458dbc]{font-weight:600;text-align:left}#v-dd-label[data-v-ac458dbc],#v-dd-label+.v-dd-label-hint[data-v-ac458dbc]{line-height:1.45;text-align:left}.v-tree-dropdown #v-dd-label+.v-dd-label-hint[data-v-ac458dbc]{color:var(--hint-color)}.v-dd:hover .v-dd-search[data-v-ac458dbc]{border-color:var(--primary-color)}.margin-0-auto[data-v-ac458dbc]{margin:0 auto}.c-btn__icon[data-v-ac458dbc]{width:16px;height:16px;margin-top:-2px;vertical-align:middle}.u-truncate[data-v-ac458dbc]{overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.v-dd-search[data-v-ac458dbc]{position:relative;display:flex;align-items:center;justify-content:space-between;border:var(--border);padding:.75rem;margin-top:.5rem;border-radius:4px;cursor:pointer;outline:none;z-index:1}.v-dd-search.compact[data-v-ac458dbc]{padding:.5rem .75rem;margin-top:.25rem}.v-dd-search[data-v-ac458dbc]:active,.v-dd-search[data-v-ac458dbc]:focus,.v-dd-search[data-v-ac458dbc]:focus-within{border-color:var(--primary-color);box-shadow:var(--box-shadow);transition:border-color .2s ease-in-out,box-shadow .2s ease-in-out}.v-dd-search>svg[data-v-ac458dbc]{position:absolute}.v-dd-search>svg[aria-labelledby=zd-search][data-v-ac458dbc]{left:1rem}.v-dd-search>svg[aria-labelledby=zd-down-pointer][data-v-ac458dbc]{right:1rem}.v-dd-search>svg[aria-labelledby=zd-down-pointer].open[data-v-ac458dbc]{transform:rotate(180deg);transition:transform .2s ease-in-out}.v-dd-search>svg[aria-labelledby=zd-down-pointer].close[data-v-ac458dbc]{transform:rotate(0);transition:transform .2s ease-in-out}.v-dd-search>input[data-v-ac458dbc],.v-dd-search>div[data-v-ac458dbc]{height:1.25rem;line-height:1.25rem;flex-grow:1;padding:0 2rem}.v-dd-input[data-v-ac458dbc]{border:none;outline:none}.v-dd-input.hide[data-v-ac458dbc]{position:absolute;width:0px;height:1px;padding:0}ul#v-dd-options-menu[data-v-ac458dbc]{position:absolute;display:flex;flex-direction:column;top:calc(100% + 5px);left:0;width:100%;max-height:500px;border:var(--border);border-radius:4px;background-color:#fff;z-index:1;padding:.25rem 0;margin:0;max-height:350px;overflow-y:auto;box-shadow:#17494d26 0 20px 30px;animation:v-dd-menu-open-ac458dbc var(--bezier-curve) 0s 1 normal;transition:display var(--bezier-curve)}.v-dd-option[data-v-ac458dbc]{position:relative;display:flex;align-items:center;justify-content:space-between;cursor:pointer;padding:.5rem 1.25rem}#v-dd-options-menu.compact>li[data-v-ac458dbc]{padding:.5rem 1.25rem}#v-dd-options-menu>li.parent-option[data-v-ac458dbc]{border-bottom:var(--border);padding:.5rem .75rem}#v-dd-options-menu.compact>li.parent-option[data-v-ac458dbc]{padding:.35rem .75rem}li.v-dd-option>svg[aria-labelledby=zd-check][data-v-ac458dbc],li.v-dd-option>svg[aria-labelledby=zd-contains][data-v-ac458dbc]{position:absolute}.v-dd-option>span[data-v-ac458dbc]{padding:0 2rem;flex-grow:1;text-align:left}.v-dd-option.no-data[data-v-ac458dbc],.v-dd-option[disabled=disabled][data-v-ac458dbc]{-webkit-user-select:none;user-select:none;pointer-events:none;opacity:.7;cursor:not-allowed}.v-dd-option>svg[aria-labelledby=zd-down-pointer][data-v-ac458dbc]{position:absolute;right:1rem;transform:rotate(-90deg)}.v-dd-option[data-v-ac458dbc]:hover,.v-dd-option[data-v-ac458dbc]:focus,.v-dd-option.active[data-v-ac458dbc]{background-color:var(--background-color)}.v-dd-option.parent-option>svg[data-v-ac458dbc]{left:.75rem;transform:rotate(90deg)}@keyframes v-dd-menu-open-ac458dbc{0%{transform:translateY(2px)}to{transform:translateY(0)}}")),document.head.appendChild(a)}}catch(d){console.error("vite-plugin-css-injected-by-js",d)}})();

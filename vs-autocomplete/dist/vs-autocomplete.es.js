...
import { openBlock as c, createElementBlock as p, createElementVNode as r, toDisplayString as O, resolveComponent as k, normalizeClass as h, createVNode as m, withDirectives as I, vModelText as S, vShow as w, createCommentVNode as f, Fragment as M, renderList as P, createBlock as _, pushScopeId as x, popScopeId as C } from "vue";
const y = (e, t) => {
...
}, L = D, T = ["color", "role", "aria-labelledby", "aria-hidden"], z = ["id"], B = ["innerHTML"];
...
}, N = (e) => (x("data-v-c9fe99a3"), e = e(), C(), e), U = {
  class: "v-tree-dropdown",
  ref: "dropdown"
}, K = { class: "v-dd" }, V = {
  for: "v-dd-search__input",
  id: "v-dd-label"
}, H = ["aria-expanded"], R = ["aria-controls", "aria-activedescendant"], j = ["innerHTML"], J = ["aria-multiselectable"], F = {
  key: 0,
  class: "v-dd-option no-data",
  role: "option"
}, G = /* @__PURE__ */ N(() => /* @__PURE__ */ r("span", null, "No options found.", -1)), Q = [
  G
], W = { class: "u-truncate label" }, X = ["id", "onClick", "aria-selected", "disabled"], Y = { class: "u-truncate" };
function Z(e, t, s, o, n, l) {
  var u;
  const d = k("svg-icon");
  return c(), p("div", U, [
    r("div", K, [
      r("label", V, O(s.label), 1),
      r("div", {
    ...
    I(r("ul", {
      ...
      (u = n.currentOptions) != null && u.length ? f("", !0) : (c(), p("li", F, Q)),
      n.selectedParent ? (c(), p("li", {
        key: 1,
        id: "v-dd-option-0",
        ...
        r("span", W, O(n.selectedParent.label), 1)
      ], 2)) : f("", !0),
      (c(!0), p(M, null, P(n.currentOptions, (i, a) => {
        var g, v, b;
        return c(), p("li", {
          key: i.label,
          ...
          (g = i.children) != null && g.length && l.hasSelectedOptions(i.children) ? (c(), _(d, {
            key: 0,
            icon: "zd-contains",
            name: "Contains",
            color: "#1f73b7"
          })) : f("", !0),
          !((v = i.children) != null && v.length) && l.isOptionSelected(i) ? (c(), _(d, {
            key: 1,
            icon: "zd-check",
            name: "Selected",
            color: "#1f73b7"
          })) : f("", !0),
          r("span", Y, O(i.label), 1),
          (b = i.children) != null && b.length ? (c(), _(d, {
            key: 2,
            icon: "zd-down-pointer",
            name: "Right arrow",
...
const te = /* @__PURE__ */ y(q, [["render", Z], ["__scopeId", "data-v-c9fe99a3"]]);
export {
  te as default
};
